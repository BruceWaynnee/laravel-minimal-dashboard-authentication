<!-- BEGIN:: Dashboard Sidebar Content Wrapper -->
    <ul id="accordionSidebar" class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion">
        ...
        <!-- utilities navbar item collapse menu -->
        <li class="nav-item">
        ...
        <!-- divider ( sidebar white horizontal line ) -->
        <hr class="sidebar-divider">
        <!-- addons heading navbar item -->
        <div class="sidebar-heading"> Addons </div>
        <!-- pages navbar item collapse menu -->
        <li class="nav-item">
        ...
        <!-- charts navbar item collapse menu -->
        <li class="nav-item">
        ...
        <!-- tables navbar item collapse menu -->
        <li class="nav-item">
